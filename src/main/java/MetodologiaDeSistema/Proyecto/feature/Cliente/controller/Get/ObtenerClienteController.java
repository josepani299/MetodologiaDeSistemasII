...
@RestController 
@RequestMapping("/api/clientes/") //esto hace que la ruta para obtener un cliente por id sea /api/clientes/{id}, donde {id} es un placeholder para el id del cliente que queremos obtener. Por ejemplo, si queremos obtener el cliente con id 5, la ruta sería /api/clientes/5.
